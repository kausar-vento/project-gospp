                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="{{ route('proses-pembayaran') }}">
                                            ...
                                            @php
                                            for ($i=1; $i <= 12; $i++) { $dropdown['months'][$i]=date('F', mktime(0, 0,
                                                0, $i, 1)); } @endphp <div class="form-group">
            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ url('list-bayar')}}" data-toggle="" aria-expanded="false" data-target="#submenu-5"
