    ...
    <div class="dashboard-wrapper">
        <div class="container-fluid  dashboard-content">
            ...
            <div class="row">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="card">
                        <h5 class="card-header"><a class="btn btn-primary" href="{{ url('tambah-petugas') }}">Tambah
                                Petugas</a></h5>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered first">
                                    ...
                                    <tbody>
                                        ...
                                        $no = 1;
                                        @endphp
                                        @foreach($operator as $tugas)
                                        <tr>
                                            <td> {{$no++}} </td>
                                            <td>{{$tugas->name}}</td>
                                            <td>{{{$tugas->email}}}</td>
                                            <td><a class="btn btn-sm btn-danger" href="{{ route('delete', $tugas->id) }}">
                                                    Hapus
                                                </a>
                                                <a class="btn btn-sm btn-primary" href="{{ route('edit.petugas', $tugas->id) }}">
                                                    Edit
                                                </a></td>
                                        </tr>
                                        @endforeach
