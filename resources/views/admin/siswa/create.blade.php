                    ...
                    <div class="col-xl-10">
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header">Form Tambah Murid</h5>
                                    <div class="card-body">
                                        ...
                                        @endif
                                        <form method="POST" action="{{ route('simpan.murid') }}">
                                            @csrf
                                            <div class="form-group">
                                                <label for="inputPassword">Nama Siswa</label>
                                            ...
                                            <div class="form-group">
                                                <label for="inputPassword">Email Siswa</label>
                                            ...
                                            <div class="form-group">
                                                <label for="inputPassword">Password Siswa</label>
                                            ...
                                            <div class="form-group">
                                                <label for="inputPassword">{{ __('Kelas') }}</label>
                                                <select class="form-control" name="kelas" >
                                                <option class="form-control">Pilih Kelas</option>
                                                    @foreach($ksl as $b)
                                                    <option class="form-control" value="{{$b->id}}">{{$b->kelas_siswa}}
                                                    </option>
                                                    @endforeach
                                                </select>
                                            </div>
