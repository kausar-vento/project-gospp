    ...
    <div class="dashboard-wrapper">
        <div class="container-fluid  dashboard-content">
            ...
            <div class="row">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="card">
                        <h5 class="card-header"><a class="btn btn-primary" href="{{ url('/tambah-murid') }}">Tambah
                                Siswa</a></h5>
                                <h5 class="card-header"><a class="btn btn-secondary" href="/siswa/export_excel">Download Data Siswa
                                </a></h5>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered first">
                                    ...
                                    <tbody>
                                        ...
                                        $no = 1;
                                        @endphp
                                        @foreach($user as $murid => $d)
                                        <tr>
                                            <td> {{$no++}} </td>
                                            <td>{{$d->name}}</td>
                                            <td>{{ $dataClass[$murid][0]->kelas_siswa }}</td>
