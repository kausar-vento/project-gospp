                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        @endif
                                        <form method="POST" action="{{ route('spp.update') }}">
                                            @csrf
                                            <input type="hidden" name="id" value="{{ $spps->id }}">
                                            <div class="form-group">
                                                <label for="inputPassword">Nama Kelas</label>
                                                <input id="tahun_ajaran" value="{{ $spps->tahun_ajaran }}" type="text"
                                                    name="tahun_ajaran"
            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#" data-toggle="" aria-expanded="false" data-target="#submenu-5"
                                aria-controls="submenu-5"><i class="fas fa-fw fa-table"></i>Pembayaran</a>
                        </li>
