                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ url('pembayaran')}}" data-toggle="" aria-expanded="false"
    ...
    <div class="dashboard-wrapper">
        <div class="container-fluid  dashboard-content">
            ...
            <div class="row">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="card">
                        <h5 class="card-header"><a class="btn btn-primary" href="{{ url('/tambah-spp') }}">Tambah
                                SPP</a></h5>
                        <div class="card-body">
                                ...
                                <table class="table table-striped table-bordered first">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a class="btn btn-sm btn-success" href="{{ route('edt', $spp->id) }}">
                                                    Edit
                                                </a>
                                                <a class="btn btn-sm btn-danger" href="{{ route('hapus', $spp->id) }}">
                                                    Hapus
                                                </a></td>
                                        </tr>
                                        @endforeach
